"""
Solución al ejercicio 3 del modelo B del examen del día 31/01/2025
...
#   - El programa contará los caracteres(incluidos espacios, puntos, etc.) distintos de letras vocales hay en la frase, y mostrará el resultado.
...
if len(linea) == 0:
    ...
    for letra in linea:
        if letra not in vocales:
            contador += 1
    print(f"En el texto introducido hay {contador} letras que no son vocales.")
