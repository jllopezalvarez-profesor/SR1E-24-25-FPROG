"""
Solución al ejercicio 1 del modelo A del examen del día 31/01/2025
Autor: José Luis López Álvarez
"""

# Enunciado
# Escribe un programa en python que:
#   - Pida al usuario dos números, numero_menor y numero_mayor.
#   - Se debe cumplir que numero_menor < numero_mayor. Si no lo es, se informará del problema.
...
#   - Números del menor al mayor, ambos incluidos. En una sola línea, separados por un espacio.
#   - Números del mayor al menor, ambos incluidos. En una sola línea, separados por un espacio.
#   - No se pueden usar listas, conjuntos, o diccionarios en este ejercicio

print("Necesito que me digas dos números, uno menor que otro.")
...
while numero_mayor <= numero_menor:
    print(f"El número {numero_mayor} es menor o igual que que {
          numero_menor}. Vuelve a intentarlo.")
    numero_menor = int(input("Dime el menor de los dos números: "))
    numero_mayor = int(input("Dime el mayor de los dos números: "))
