"""
Solución al ejercicio 3 del modelo A del examen del día 31/01/2025
...
#       - En posiciones pares, el número de la primera primera lista más el de la segunda(de las mismas posiciones).
#       - En posiciones impares, el valor será el número de la primera lista menos el de la segunda lista(de las mismas posiciones)
